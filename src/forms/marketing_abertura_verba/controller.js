    ...
    function MarketingAberturaVerbaController(
      ...
      vm.inicia = function inicia() {
        ...
        fluigService.getUsuarios(vm.Params.user).then((resp) => {
          vm.Usuario = resp[0];
          vm.checkEtapa();
          vm.calculaTotais(); //testar isso aqui.
        });
      ...
      vm.checkRegras = function checkRegras() {
        ...
        [
          ...
          {
            regra: "enableValidacaoMarketing",
            def: vm.Params.edit,
            etapas: ["validarMarketing"],
          },
          {
            regra: "showReenvia",
            def: true,
          ...
          {
            regra: "showRateioCategoria",
            def: true,
            etapas: vm.etapas,
          },
          {
            regra: "showResumoVerbasCliente",
            def: true,
            etapas: vm.etapas,
          },
          {
          ...
          {
            regra: "enableAprovGerMarketing",
            def: true,
            etapas: ["aprovarGerMarketing"],
          },
          {
            regra: "showAprovPresidenciaVp",
            def: true,
            etapas: [
              "consulta",
              "revisarSolicitacao",
          ...
          {
            regra: "enableAprovPresidenciaVp",
            def: true,
            etapas: ["aprovarPresidencia"],
          },
          ...
          {
            regra: "showNotificacaoCliente",
            def: true,
            etapas: vm.etapas,
          },
          {
            regra: "enableNotificacaoCliente",
            def: vm.Params.edit,
            etapas: vm.etapas,
          },

          {
            regra: "showEvidencias",
            def: true,
            etapas: [
              "consulta",
              "enviarEvidencias",
          ...
          {
            regra: "enableEvidencias",
            def: true,
            etapas: ["enviarEvidencias", "analisarErros"],
          },
          {
            regra: "enableValidacaoEvidencias",
            def: true,
            etapas: ["validarEvidencias", "analisarErros"],
          },
      ...
      vm.copiaDadosAcao = () => {
        [
          ...
          vm.Formulario[field] = globalService.isJson(
            vm.Formulario.acaoCopiada[field]
          )
            ? JSON.parse(vm.Formulario.acaoCopiada[field])
            : vm.Formulario.acaoCopiada[field];
        });
      ...
      vm.calculaItemErp = function (item, loadContainer) {
        if (item.item && item.item.codigo && item.alterado) {
          if (
            ...
            (vm.Formulario.tipoAcao.tipoAcaoCodigo == "price" &&
              vm.Formulario.tipoprice == "net") ||
            (vm.Formulario.tipoAcao.tipoAcaoCodigo == "sellin" &&
              vm.Formulario.tipoSellin == "net")
          ) {
      ...
      vm.changeTipoAcao = function changeTipoAcao() {
        ...
        vm.Formulario.itensprice = []; //Alteraçao ACL
      ...
      vm.getItens = () => {
        ...
        if (
          ...
          switch (vm.Formulario.tipoAcao.tipoAcaoCodigo) {
            ...
            //=============================Alteração ACL==========================================
            case "price":
              vm.Formulario.itensprice.forEach(function (it, index) {
                console.log("TGO + ACL price it:", it);
                vm.ItensEvidencia.push({
                  tablename: "itensprice",
                  index: index,
                  descricao: it.item.displaykey,
      ...
      vm.calculaTotais = function calculaTotais() {
        ...
        if (vm.Formulario.tipoAcao && vm.Formulario.tipoAcao.tipoAcaoCodigo) {
          switch (vm.Formulario.tipoAcao.tipoAcaoCodigo) {
            ...
            //=============================== Alteração ACL========================================
            // case "price":
            //     vm.Formulario.itensprice.forEach(function (o) {
            //     vm.Formulario.valorTotalVerba += o.rebateTotal || 0, a++
            // }), vm.calculaPercCategoria();
            // break;
            case "price":
              "net" == vm.Formulario.tipoprice
