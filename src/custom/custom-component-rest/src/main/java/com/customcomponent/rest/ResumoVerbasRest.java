 ...
 * Endpoint
 * 
 * POST: /customcomponent-api/v1/resumo | Lista resumo de verbas do usuário
 * 
 */
...
public class ResumoVerbasRest {
    ...
    public Response getResumoVerbas(@PathParam("guid") String guid,
        ...
        try {
            ...
            log.info(String.format("---- Customcomponent - API Request | GET: /resumo/search v3"));
            log.info(String.format("---- Customcomponent - API Request | GET: /resumo/search guid: %s",
                    guid));
