...
import com.customcomponent.impl.*;
 ...
 * Endpoint
 * 
 * POST: /custom-api/v1/marketing | Movimenta o fluxo do marketing conforme uuid recebido
 * 
 */
...
public class MarketingComponentRest {
  ...
  public Response getMarketingFlowData(@PathParam("guid") String guid,
    ...
    try {
      ...
      log.info(String.format("---- Customcomponent - API Request | GET: /marketing/search v3"));
      log.info(String.format("---- Customcomponent - API Request | GET: /marketing/search guid: %s", guid));
  ...
  public Response getMarketingFlowData(@Context HttpHeaders headers) {
    try {
      ...
      log.info(String.format("---- Customcomponent - API Request | GET: /marketing/textos v3"));
