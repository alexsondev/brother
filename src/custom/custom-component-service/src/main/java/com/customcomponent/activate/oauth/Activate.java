package com.customcomponent.activate.oauth;
 ...
 */
@Remote
@Stateless(mappedName = "activator/customcomponent", name = "activator/customcomponent")
public class Activate implements ActivationListener {
     ...
     */
    private static final String APP_KEY = "1111-5678-9876-9999";
    

    @Override
    public String getArtifactFileName() throws Exception {
        return "custom-component-service.jar";
    }
